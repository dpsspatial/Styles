...
<qgis version="2.10.1-Pisa" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{8d46ef6a-5674-48f9-b4c3-28fe13e3edef}">
      <rule filter="&quot;highway&quot; is not null" key="{d3e6ef7f-6442-44e8-a822-da550a8777bd}" label="roads">
        <rule filter="&quot;highway&quot; = 'motorway' " key="{28764870-74d0-4b8e-93fc-decaa9d237f0}" label="motorway">
          <rule filter="&quot;other_tags&quot; like '%&quot;layer&quot;=>&quot;-%' = 0" key="{1624f0ba-fcb6-4492-9b06-40c5f352a846}" symbol="0" label="motorway"/>
          <rule filter="&quot;other_tags&quot; like '%&quot;layer&quot;=>&quot;-%' = 1" key="{ff256086-5882-46f0-8df0-f64ced88e209}" symbol="1" label="tunnel"/>
        </rule>
        <rule filter="&quot;highway&quot; IN ( 'motorway_link','trunk','primary')" key="{82c11331-4eda-472f-8228-d9b912555752}" label="trunk &amp; primary">
          <rule filter="&quot;other_tags&quot; like '%&quot;layer&quot;=>&quot;-%' = 0" key="{4c8f6f2f-002e-4afa-b8e8-0625411df820}" symbol="2" label="trunk &amp; primary"/>
          <rule filter="&quot;other_tags&quot; like '%&quot;layer&quot;=>&quot;-%' = 1" key="{ecb3d1b3-598e-416a-8be2-4c53b0586107}" symbol="3" label="tunnel"/>
        </rule>
        <rule filter="&quot;highway&quot; IN ( 'trunk_link','primary_link','secondary','secondary_link','road','tertiary','tertiary_link')" key="{c543f8cc-aaba-4759-b94b-a7a32c462e91}" symbol="4" label="roads"/>
        <rule scalemaxdenom="1000" checkstate="0" filter="&quot;highway&quot; is not null" key="{3f178868-585b-4a39-8e09-3cf08c7a2f15}" symbol="5" scalemindenom="1" label="minor roads"/>
        <rule scalemaxdenom="125000" checkstate="0" filter="&quot;highway&quot; is not null and &quot;other_tags&quot; != '&quot;service&quot;=>&quot;alley&quot;'" key="{5346d7d6-f883-455b-bdd6-e27092cae274}" symbol="6" scalemindenom="1000" label="minor roads"/>
      </rule>
      <rule checkstate="0" filter="&quot;other_tags&quot; LIKE '%&quot;rail&quot;%' or &quot;other_tags&quot; LIKE '%&quot;railway&quot;%'" key="{7c69b885-eea7-4782-8102-c9d67db18156}" symbol="7" label="rails"/>
      <rule filter="&quot;waterway&quot; = 'river'" key="{4f76a9d8-df9b-4f25-b132-0384d1b9291d}" label="river">
        <rule scalemaxdenom="125000" key="{f327d431-f7c0-4080-847e-4672d2cb5906}" symbol="8" scalemindenom="1000" label="river"/>
        <rule key="{c1e53c3c-e372-4c42-94b7-43e877762cf5}" symbol="9" scalemindenom="125000" label="river"/>
      </rule>
    </rules>
    <symbols>
